...
/** To run only this test:
  *
  * test-only de.sciss.numbers.NumbersSpec
  */
class NumbersSpec extends AnyFlatSpec {
  import Implicits._

  "Rich int operators" should "work" in {
  ...
  "Rich float operators" should "work" in {
  ...
  "Rich double operators" should "work" in {
